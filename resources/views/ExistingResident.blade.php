...
<div class="form-group bg-light pd-60px row justify-content-center align-items-center">
    <select class="form-control width-50" id="SelExample" >
      ...
      @empty
      <option value="0">No Resident Found</option>
      @endforelse
      </select>
<br>
      <a data-href="{{ route('resident.tax.details', $item->id) }}" role="button" id="but_read" class="btn btn-secondary width-51" style="display:none; margin-top:30px">Go to Resident</a>
    <span id="result"></span>
